...
const VideoTitle = ({ title }) => {
  ...
  return (
    <>
      <div className="pt-[30%]  hidden md:block px-6 md:px-20 w-screen aspect-video  absolute bg-gradient-to-r from-black ">
          ...
          <div className="mt-8 md:mt-4 py-2">
            <Link to={'/browse/' + id}>
              <button className=" px-4 py-1 md:hover:scale-95  md:px-8 md:py-2 rounded-md text-center mr-4  bg-white hover:bg-gray-200  text-black font-semibold text-xl">
                <Play fill="black" className="inline mb-1" />Catch a Glimpse
              </button>
            </Link>
            <Link to="/user">
